...
# TODO: to be finished
class DilatedCausalConv1dStack(nn.Module):
    def __init__(self,
            in_channels,
            out_channels,
            kernel_size,
            base_dilation_pattern: List[int] = [1, 2, 4, 8, 16, 32, 64],
            dilation_pattern_repeat: int = 2):
        super().__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
        self.kernel_size = kernel_size
        self.base_dilation_pattern = base_dilation_pattern
        self.dilation_pattern_repeat = dilation_pattern_repeat
        ...
        @property
        def dilation_pattern(self):
            return self.base_dilation_pattern * self.dilation_pattern_repeat
...
class DTLNSeparationCore(nn.Module):
    ...
    def __init__(self,
        ...
        self.separation_core = nn.ModuleDict({
            ...
            "fcl": nn.Linear(self.hidden_size, self.output_size),

...
class Dataset(BaseDataset):
    ...
    def snr_mix(clean_y, noise_y, conv_y, snr, target_dB_FS, target_dB_FS_floating_value, use_reverb=True, eps=1e-6, num_trainfile_examples=10, sr=16000):
        ...
        clean_y, clean_norm_scalar = norm_amplitude(clean_y)
        clean_y, _, clean_tar_dB_scalar = tailor_dB_FS(clean_y, target_dB_FS)
        ...
        clean_y_reverberant = clean_y_reverberant/clean_norm_scalar*clean_tar_dB_scalar
